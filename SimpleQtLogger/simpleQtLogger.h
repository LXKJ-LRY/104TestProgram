...
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_LOG_SINK_FILE;    // Log-sink: true: enable, false: disable, default: true
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_LOG_SINK_CONSOLE; // Log-sink: true: enable, false: disable, default: false
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_LOG_SINK_QDEBUG;  // Log-sink: true: enable, false: disable, default: false
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_LOG_SINK_SIGNAL;  // Log-sink: true: enable, false: disable, default: false
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_LOG_SINK_SYSLOG;  // Log-sink: true: enable, false: disable, default: false

#ifdef Q_OS_LINUX
  SIMPLEQTLOGGER_EXPORT extern QString NAME_LOG_SINK_SYSLOG; // String is prepended to every message. If empty, the program name is used.
  SIMPLEQTLOGGER_EXPORT extern int FACILITY_LOG_SINK_SYSLOG; // Used to specify what type of program is logging the message.
#endif
...
SIMPLEQTLOGGER_EXPORT extern EnableLogLevels ENABLE_LOG_LEVELS;

// Log-function stack-trace
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_FUNCTION_STACK_TRACE; // Log-function stack-trace: true: enable, false: disable, default: true

// Sink console color
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_CONSOLE_COLOR; // Color for sink console: true: enable, false: disable, default: true
// Sink console trimmed messages
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_CONSOLE_TRIMMED; // Whitespaces trimmed for sink console: true: enable, false: disable, default: true

// Console
SIMPLEQTLOGGER_EXPORT extern bool ENABLE_CONSOLE_LOG_FILE_STATE; // Console output log-file state: true: enable, false: disable, default: true
...
class SIMPLEQTLOGGER_EXPORT SimpleQtLogger : public QObject
{
  Q_OBJECT
...
public:
  ...
  bool connectSinkSignalLog(const QObject* receiver, const char* method,
                            Qt::ConnectionType type = Qt::AutoConnection); // You must use the SLOT() macro when specifying the method, e.g. SLOT(mySlotLog(simpleqtlogger::LogLevel, const QString&))
...
private:
  ...
  QMutex _mutex;
  QMap<unsigned long long int, unsigned int> _stackDepth; // current stack-depth per thread-id for function-log
};
